...
window.onload = function () {    
	onInit(createEditor('config/diagrameditor.xml'));
};    
  ...
  function createEditor(config) {
    ...
    return editor;
		...
		function onInit(editor)
		{
			...
			m.mxConnectionHandler.prototype.connectImage = new m.mxImage('images/connector.gif', 16, 16);
			...
			for (var i = 0; i < buttons.length; i++)
			{
				...
				m.mxUtils.write(button, m.mxResources.get(buttons[i]));
		...
		window.onbeforeunload = function() { return m.mxResources.get('changesLost'); };
